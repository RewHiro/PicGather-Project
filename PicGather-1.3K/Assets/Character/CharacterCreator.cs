...
public class CharacterCreator : MonoBehaviour {
    ...
    IEnumerator Create()
    {
        ...
        if (IsFairy)
        {
            Clone.transform.FindChild("fairy").GetComponent<Renderer>().material.mainTexture = Manager.CampusTexture;
        }
        else
        {
            Clone.GetComponent<Renderer>().material.mainTexture = Manager.CampusTexture;
        }
